...
// import ChristianResume' from ".../public/ChristianRichardRes.pdf";
      ...
      <MDBCard>
        <MDBCardBody>
          ...
          {/* const onButtonClick = () ={">"}
          {
            ...
            fetch({ ChristianResume' }).then((response) => {
              response.blob().then((blob) => {
                ...
                alink.href = fileURL;
                alink.download = { ChristianResume' };
                alink.click();
              });
            })
          }
